      ...
      >
        ...
        <div className="flex-1 flex relative">
          <Image
            ...
            width={414}
            height={231}
            // className={`w-full aspect-116/69 max-w-110 ${left ? "mr-auto" : "ml-auto"} rounded-lg object-cover border border-gray-300`}
            className="w-full aspect-116/69 max-w-110 rounded-lg object-cover border border-gray-300"
          />
        </div>
        ...
        <div className="flex-1 space-y-6">
          <div ref={textsRef}>
            <h3 className="font-[Manrope] text-[#7B5A41] leading-11.5 tracking-[4.6px] uppercase mb-6">
              {title}
            </h3>

            <p className="font-[Manrope] leading-9.75 mb-8 max-w-131.25 normal-case">
              {content}
            </p>
          </div>
        </div>
