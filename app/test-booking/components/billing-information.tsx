...
const BillingInformation = () => {
  ...
  //       setSameAsPrimary(data.sameAsPrimary || false);
  ...
  //   useEffect(() => {
  //     const data = { sameAsPrimary, firstName, lastName, email, phone };
  //     sessionStorage.setItem(STORAGE_KEY, JSON.stringify(data));
  //   }, [sameAsPrimary, firstName, lastName, email, phone]);
  ...
  return (
    ...
    >
      ...
      <p className="mb-4 text-[#6D6D6D]">Main point of communication for this reservation</p>
