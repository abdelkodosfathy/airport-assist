import { VipBookingData } from "@/components/BookingForm/BookingForm";
    ...
    >
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Input
            ...
            onChange={(e) => update("flight[flight_number]", e.target.value)}
          />
          <Input
            type="number"
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input
            placeholder="First name"
            onChange={(e) => update("passenger[first_name]", e.target.value)}
          />
          <Input
            placeholder="Last name"
        ...
        <Textarea
          ...
          className="w-full"
          onChange={(e) => update("passenger.other_passengers", e.target.value)}
        />
      </section>
